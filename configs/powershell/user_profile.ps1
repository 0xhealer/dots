...
${section}󰊢 GitHub CLI${reset}
${dim}────────────────────────────────────────────────────${reset}
${command}ghclone <repo>${reset}     ${accent}→${reset} ${desc}Clone a GitHub repository and enter it${reset}
${command}ghclone <user> <repo>${reset}
${accent}→${reset} ${desc}Clone a repository from another user${reset}
${command}ghcreate <repo> <visibility>${reset}
${accent}→${reset} ${desc}Create, clone, and enter a GitHub repository${reset}
...
${section}󰋖 Profile${reset}
${dim}────────────────────────────────────────────────────${reset}
${command}Show-Help${reset}          ${accent}→${reset} ${desc}Display this PowerShell profile help menu${reset}
